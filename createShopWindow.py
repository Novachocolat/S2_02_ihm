...
from PyQt6.QtWidgets import (
    ...
    QFileDialog, QApplication, QDateEdit, QGroupBox, QFormLayout, QMessageBox, 
)
...
class CreateShopWindow(QDialog): 
    ...
    def setup_ui(self):
        ...
        if self.shop_data:
            ...
            if articles_json and os.path.isfile(articles_json):
    ...
    def finish(self):
        ...
        # Toujours insérer un nouveau magasin
        c.execute("""
